...
import com.beginner.translite.databinding.Screen1CopyBinding
...
class MainActivityCopy : AppCompatActivity() {
    ...
    private lateinit var binding:Screen1CopyBinding
    private lateinit var translate_query:TransQuery

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Screen1CopyBinding.inflate(layoutInflater)
